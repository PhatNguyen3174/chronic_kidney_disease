...
def main():
    ...
    with col1:
        ...
        if st.button("Mở ứng dụng"):
            os.system("streamlit run D:/HocMayTH/DOANCUOIKI/giaodien/thongtinbenhnhanlr.py")

    # Cột phải
    with col2:
        st.title("CKD bằng Bernoulli Naive Bayes")
        if st.button("Mở ứng dụng 2"):
             os.system("streamlit run D:/HocMayTH/DOANCUOIKI/giaodien/thongtinbenhnhanbnb.py")
